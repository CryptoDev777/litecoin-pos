...
# TestP2PConn: A peer we use to send messages to litecoin-posd, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes litecoin-posd to (reasonably!) disconnect us, so do this last.
    ...
    # litecoin-posd's choice of nonce.
    ...
    # Test that litecoin-posd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for litecoin-posd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # litecoin-posd will not send blocktxn responses for blocks whose height is
