# Fuzzing Litecoin-PoS Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Litecoin-PoS Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
Every single pull request submitted against the Litecoin-PoS Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Litecoin-PoS Core more robust.
...
with certain assembly code from Litecoin-PoS Core's code. See [developer notes on sanitizers](https://github.com/bitcoin/bitcoin/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Litecoin-PoS Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Litecoin-PoS Core using [`afl-fuzz`](https://github.com/google/afl):
