...
- #12843 `df38b13` Test starting litecoin-posd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure litecoin-posd processes are cleaned up when tests end (sdaftuar)
