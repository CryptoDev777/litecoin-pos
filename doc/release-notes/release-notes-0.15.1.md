...
- #10798 `716066d` test litecoin-pos-cli (jnewbery)
...
- #11125 `812c870` Add litecoin-pos-cli -stdin and -stdinrpcpass functional tests (promag)
...
### Miscellaneous
- #11377 `75997c3` Disallow uncompressed pubkeys in litecoin-pos-tx [multisig] output adds (TheBlueMatt)
