...
We recommend that everybody running prior versions of litecoin-posd/Bitcoin-Qt
...
bitcoin up-to-date.  Just type
  ...
  sudo apt-get update
in your terminal, then install the litecoin-pos-qt package:
  sudo apt-get install litecoin-pos-qt
...
* (Windows only): enable ASLR and DEP for litecoin-pos-qt.exe
* (Windows only): add meta-data to litecoin-pos-qt.exe (e.g. description)
...
* Bash programmable completion for litecoin-posd(1)
