...
For example, add the following to `litecoin-pos.conf`:
...
- #5809 `46bfbe7` Add litecoin-pos-cli man page
...
- #5849 `41259ca` contrib/init/litecoin-posd.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for litecoin-pos-tx)
