...
/Applications/Bitcoin-Qt (on Mac) or litecoin-posd/litecoin-pos-qt (on Linux).
...
code, causing the Bitcoin-Qt or litecoin-posd process to crash.
...
Linux: clicking on litecoinpos: links was broken if you were using
