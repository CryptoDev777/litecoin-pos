# Support for Output Descriptors in Litecoin-PoS Core

Since Litecoin-PoS Core v0.17, there is support for Output Descriptors. This is a
...
on Litecoin-PoS's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Litecoin-PoS Core wallets, a convenience function `combo` is
...
All RPCs in Litecoin-PoS Core will include the checksum in their output. Only
