 ...
 *  A CTxDestination is the internal data type encoded in a litecoin-pos address
 */
...
/**
 * Generate a Litecoin PoS scriptPubKey for the given CTxDestination. Returns a P2PKH
